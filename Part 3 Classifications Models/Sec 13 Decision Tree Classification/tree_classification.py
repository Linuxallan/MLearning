...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  4 19:47:44 2022
...
#""" El escalado de datos no tiene sentido en un metodo de Clasificacion con Arbol de Desicion.
# Escalar datos 
...
for i, j in enumerate(np.unique(Y_set)):
    plt.scatter(X_set[Y_set == j, 0], X_set[Y_set == j, 1],
                c = ListedColormap(('red', 'green'))(i), label = j)
plt.title('Arbol de desicion (Conjunto de Testing)')
plt.xlabel('Edad')

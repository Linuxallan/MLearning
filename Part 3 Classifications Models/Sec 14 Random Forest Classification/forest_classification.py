...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  4 23:10:30 2022

@author: allancortez
"""

# Random Forest Classification (Clasificacion con Bosque Aleatorio)
...
#"""
# Random Forest no es un algoritmo basado en distancias, por lo que es inutil escalar los datos
# Escalar datos 
...
for i, j in enumerate(np.unique(Y_set)):
    plt.scatter(X_set[Y_set == j, 0], X_set[Y_set == j, 1],
                c = ListedColormap(('red', 'green'))(i), label = j)
plt.title('Clasificador Bosque Aleatorio (Conjunto de Testing)')
plt.xlabel('Edad')

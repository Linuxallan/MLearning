...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  3 17:39:25 2022

@author: allancortez
"""

# K - Nearest Neighbors (K-NN)   # Numero de Vecinos mas Cercanos
...
classifier = KNeighborsClassifier(n_neighbors=5, metric='minkowski', p=2) # 'p' --> validacion Eucladiana (no es lineal)
